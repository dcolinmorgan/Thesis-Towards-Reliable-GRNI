...
\caption{\textbf{Abbreviated view of MYC double perturbation angle dendrogram}, as an example demonstrating independence of gene expression via correlation in dataset.}
\label{fig:dend}
\end{figure}
